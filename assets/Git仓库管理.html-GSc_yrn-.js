...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,14),v={href:"https://git-scm.com/docs/git-config#Documentation/git-config.txt-corehooksPath",target:"_blank",rel:"noopener noreferrer"},u=n("code",null,"core.hooksPath",-1),b=n("code",null,"npm scripts",-1),m={href:"https://github.com/typicode/husky",target:"_blank",rel:"noopener noreferrer"},k=i(`<p><code>~/.husky</code> 目录下手动创建 hook 脚本。</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 手动创建 pre-commit hook</span>
...
<span class="token comment"># 在存在 husky 时，提交不走校验流程</span>
<span class="token function">git</span> commit <span class="token parameter variable">-m</span> <span class="token string">&#39;提交信息描述&#39;</span> --no-verify
...
<span class="token comment"># 根据作者查看日志信息</span>
<span class="token function">git</span> log <span class="token parameter variable">--author</span><span class="token operator">=</span><span class="token string">&quot;willsliang&quot;</span> <span class="token comment"># 查看 &#39;willsliang&#39; 的所有提交（精确名称）</span>
<span class="token function">git</span> log <span class="token parameter variable">--author</span><span class="token operator">=</span><span class="token string">&quot;willy.*&quot;</span> <span class="token comment"># 查看名称含 &#39;willy&#39; 的提交（正则）</span>
<span class="token function">git</span> log <span class="token parameter variable">--format</span><span class="token operator">=</span><span class="token string">&quot;%h %ae %s&quot;</span> <span class="token operator">|</span> <span class="token function">grep</span> <span class="token string">&quot;willysliang@qq.com&quot;</span> <span class="token comment"># 根据用户邮箱来查看日志信息</span>
<span class="token function">git</span> log <span class="token parameter variable">--author</span><span class="token operator">=</span><span class="token string">&quot;Alex&quot;</span> <span class="token parameter variable">-n</span> <span class="token number">5</span> <span class="token comment"># 查看最近5条</span>
<span class="token function">git</span> log <span class="token parameter variable">--author</span><span class="token operator">=</span><span class="token string">&quot;willy&quot;</span> <span class="token parameter variable">--since</span><span class="token operator">=</span><span class="token string">&quot;2025-01-01&quot;</span> <span class="token parameter variable">--until</span><span class="token operator">=</span><span class="token string">&quot;2025-12-31&quot;</span> <span class="token comment"># 查看2025年的提交</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="拉取代码-fetch-pull" tabindex="-1"><a class="header-anchor" href="#拉取代码-fetch-pull"><span>拉取代码 fetch/pull</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token variable"><span class="token variable">\`</span><span class="token function">git</span> pull<span class="token variable">\`</span></span>：相当于是从远程获取最新版本并merge到本地，等价于 <span class="token variable"><span class="token variable">\`</span><span class="token function">git</span> fetch <span class="token operator">&amp;&amp;</span> <span class="token function">git</span> merge FETCH_HEAD<span class="token variable">\`</span></span>
<span class="token variable"><span class="token variable">\`</span><span class="token function">git</span> fetch<span class="token variable">\`</span></span>：相当于是从远程获取最新版本到本地，不会自动merge


<span class="token comment">### 清理不存在于远程的本地跟踪分支</span>
过时的远程跟踪分支（即那些已经在远程仓库中被删除，但在本地仍然存在的分支）可以通过添加 <span class="token parameter variable">--prune</span> 选项来清理
<span class="token variable"><span class="token variable">\`</span>$ <span class="token function">git</span> fetch origin <span class="token parameter variable">--prune</span><span class="token variable">\`</span></span>
或 <span class="token variable"><span class="token variable">\`</span>$ <span class="token function">git</span> fetch <span class="token parameter variable">-p</span><span class="token variable">\`</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></blockquote><h4 id="缓存远程仓库账号密码" tabindex="-1"><a class="header-anchor" href="#缓存远程仓库账号密码"><span>缓存远程仓库账号密码</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">## GitLab无需每次输入账号密码</span>
<span class="token number">1</span>. 添加SSH到本地，然后把SHH放入GitLab上
<span class="token number">2</span>. 若再次拉取代码和提取代码应无需再输密码，若还需输入密码
   <span class="token number">1</span>. 缓存输入的用户名和密码：在命令行中输入 <span class="token variable"><span class="token variable">\`</span>$ <span class="token function">git</span> config <span class="token parameter variable">--global</span> credential.helper store<span class="token variable">\`</span></span>
...
<span class="token comment">## 删除 git 缓存中的账号密码（不建议使用）</span>
<span class="token function">git</span> credential-manager uninstall


<span class="token comment">## 管理记录的账号密码</span>
打开“控制面板” -<span class="token operator">&gt;</span> “用户帐户” -<span class="token operator">&gt;</span> “凭据管理器” -<span class="token operator">&gt;</span> “Windows 凭据”
在“普通凭据”或“Windows 凭据”列表中，找到与你的 Git 服务器（如 git:https://github.com）相关的凭据
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="同时推送两个存储库并保持同步" tabindex="-1"><a class="header-anchor" href="#同时推送两个存储库并保持同步"><span>同时推送两个存储库并保持同步</span></a></h4><blockquote><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">git</span> remote set-url <span class="token parameter variable">--add</span> <span class="token parameter variable">--push</span> origin git@github.com:lio-zero/blog.git
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="远程仓库操纵" tabindex="-1"><a class="header-anchor" href="#远程仓库操纵"><span>远程仓库操纵</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">## 克隆GitHub项目到本地</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="从一个git仓库拷贝到另一个git仓库" tabindex="-1"><a class="header-anchor" href="#从一个git仓库拷贝到另一个git仓库"><span>从一个git仓库拷贝到另一个git仓库</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">## 从一个git仓库拷贝到另一个git仓库</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="重写历史记录信息" tabindex="-1"><a class="header-anchor" href="#重写历史记录信息"><span>重写历史记录信息</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code> 更改所有提交者信息到自己的名称和邮箱在 Git 中被称为重写历史，这在一些情况下是有用的，例如，如果一个贡献者错误地使用了一个不正确的邮箱进行了提交，或者出于隐私保护的目的需要修改提交信息

 注意：重写已公开的提交历史是有风险的，因为它会影响所有已有的克隆和分支。如果其他人基于这些提交进行了工作，他们将不得不手动解决冲突。在团队项目中，这通常需要团队内部的协调。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">git</span> filter-branch --env-filter <span class="token string">&#39;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>更换某个特定用户的名字跟邮箱地址</strong></p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">git</span> filter-branch --env-filter <span class="token string">&#39;
OLD_EMAIL=&quot;旧的邮箱地址&quot;
NEW_NAME=&quot;新名字&quot;
NEW_EMAIL=&quot;新邮箱&quot;
...
<span class="token comment">### 保留主分支，删除其他所有本地分支</span>
- <span class="token variable"><span class="token variable">\`</span>$ <span class="token function">git</span> branch <span class="token operator">|</span> <span class="token function">grep</span> <span class="token parameter variable">-v</span> <span class="token string">&quot;master&quot;</span> <span class="token operator">|</span> <span class="token function">xargs</span> <span class="token function">git</span> branch <span class="token parameter variable">-D</span><span class="token variable">\`</span></span>
    - <span class="token variable"><span class="token variable">\`</span>$ <span class="token function">git</span> branch<span class="token variable">\`</span></span> 列出所有本地分支。
    - <span class="token variable"><span class="token variable">\`</span>$ <span class="token function">grep</span> <span class="token parameter variable">-v</span> <span class="token string">&quot;master&quot;</span><span class="token variable">\`</span></span> 过滤掉名为master的分支，如果你的主分支有不同的名称，请替换master。
    - <span class="token variable"><span class="token variable">\`</span>$ <span class="token function">xargs</span> <span class="token function">git</span> branch <span class="token parameter variable">-D</span><span class="token variable">\`</span></span> 对于通过管道传递的每个分支名称，都执行 <span class="token variable"><span class="token variable">\`</span><span class="token function">git</span> branch <span class="token parameter variable">-D</span><span class="token variable">\`</span></span> 命令强制删除分支。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="合并分支" tabindex="-1"><a class="header-anchor" href="#合并分支"><span>合并分支</span></a></h4><blockquote><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">## 合并分支</span>
...
<span class="token comment">### 在 cherry-pick 中遇到冲突</span>
使用 <span class="token variable"><span class="token variable">\`</span><span class="token function">git</span> cherry-pick <span class="token parameter variable">--about</span><span class="token variable">\`</span></span> 来取消这次 cherry-pick 操作，并尝试回到执行 cherry-pick 之前的状态。
...
此外，还有一些可选的消息类型，如：
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="基准线-rebase" tabindex="-1"><a class="header-anchor" href="#基准线-rebase"><span>基准线 rebase</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token variable"><span class="token variable">\`</span><span class="token function">git</span> rebase<span class="token variable">\`</span></span>操作的特点：把分叉的提交历史<span class="token string">&quot;整理&quot;</span>成一条直线，看上去更直观。缺点是本地的分叉提交已经被修改过了。
 ...
 - 保持分支同步：当主分支<span class="token punctuation">(</span>如main/master<span class="token punctuation">)</span>更新时，可以通过变基将当前分支的提交基于最新的主分支积蓄开发，确保代码与上游一致


合并分支中 rebase 和 merge 的区别
- <span class="token function">git</span> merge 提交历史会保留分支结构，生成合并提交。冲突会在合并时一次性解决。适用于保留分支合并历史场景。
		会让2个分支的提交按照提交时间进行排序，并且会把最新的commit合并成一个commit。最后的分支树呈现非线性的结构
- <span class="token function">git</span> rebase 提交历史呈线性，无合并提交。冲突在变基过程中逐个提交解决。适用于本地整理提交或同步分支。
		将分支提交复制到要变基分支的最新提交之后，会形成一个线性的分支树


常用场景
<span class="token number">1</span>. 本地分支与主分支同步：在功能分支开发时，主分支有更新，使用变基保持功能分支基于最新代码
		<span class="token function">git</span> checkout feature-branch
		<span class="token function">git</span> rebase main <span class="token comment"># 将 feature-branch 的提交变基到 main 的最新提交上</span>

<span class="token number">2</span>. 合并前整理提交历史：将多个琐碎的提交合并位逻辑清晰的提交，提升可读性
		<span class="token function">git</span> rebase <span class="token parameter variable">-i</span> HEAD~3 <span class="token comment"># 交互式变基，合并或修改最近3个提交</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token number">1</span>. 从主分支创建功能分支
		<span class="token function">git</span> checkout <span class="token parameter variable">-b</span> feature

<span class="token number">2</span>. 在feature 分支开发并提交多次

<span class="token number">3</span>. 主分支更新后<span class="token punctuation">(</span>在创建新分支后主分支有新提交记录<span class="token punctuation">)</span>，将 feature 分支变基到最新主分支
    <span class="token function">git</span> checkout main
    <span class="token function">git</span> pull <span class="token comment"># 更新主分支</span>
    <span class="token function">git</span> checkout feature
    <span class="token function">git</span> rebase main <span class="token comment"># 解决可能出现的冲突</span>

<span class="token number">4</span>. 将变基后的 feature 分支合并到主分支
		<span class="token function">git</span> checkout main
		<span class="token function">git</span> merge feature <span class="token comment"># 此时会生成快进合并(Fast-forward)，无合并提交</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="标签管理-tag" tabindex="-1"><a class="header-anchor" href="#标签管理-tag"><span>标签管理 tag</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">## 标签管理</span>
- 打标签的目的是记录该版本的发表。
...
- 删除远程特定标签：
		- <span class="token variable"><span class="token variable">\`</span><span class="token function">git</span> push origin <span class="token parameter variable">--delete</span> tag <span class="token operator">&lt;</span>标签名<span class="token operator">&gt;</span><span class="token variable">\`</span></span>
		- <span class="token variable"><span class="token variable">\`</span><span class="token function">git</span> push origin :refs/tags/<span class="token operator">&lt;</span>标签名<span class="token operator">&gt;</span><span class="token variable">\`</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="lint-staged" tabindex="-1"><a class="header-anchor" href="#lint-staged"><span>lint-staged</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>lint-staged 是一个在git暂存区上运行linters的工具。它将根据package.json依赖项中的代码质量工具来安装和配置 husky 和 lint-staged ，因此请确保在此之前安装lint-staged，并配置所有代码质量工具，比如Prettier和ESlint。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="commitlint" tabindex="-1"><a class="header-anchor" href="#commitlint"><span>commitlint</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>提交时，进行提交信息验证，是否符合规范。 这里使用到一个 commitlint 的包
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">### 添加命令</span>
