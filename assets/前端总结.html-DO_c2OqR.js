import{_ as n,o as s,c as a,d as e}from"./app-Bf_tkh-q.js";const i="/blog/assets/bVcQV0-6KW3Edhs.png",t="/blog/assets/image-20220104003115957-DSezzj-i.png",l="/blog/assets/image-20211224134943355-DUu8L1Xn.png",p="/blog/assets/image-20211025153149658-CtZB12o7.png",c={},o=e(`<h2 id="待复习" tabindex="-1"><a class="header-anchor" href="#待复习"><span>待复习</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>- <span class="token variable"><span class="token variable">\`</span><span class="token function">docker</span><span class="token variable">\`</span></span> 前端应用部署工具
...
<span class="token comment">## 在前端开发中，什么样的代码会导致性能很低？</span>
...
<span class="token number">6</span>. 过度地进行Http请求，而因http2之前，请求最大并发数量为6，从而导致请求阻塞
...
<span class="token comment">## 隐藏元素的方法：display:none、visibility:hidden、opacity:0 的区别</span>
  ...
  <span class="token number">3</span>. <span class="token variable"><span class="token variable">\`</span>display:none<span class="token variable">\`</span></span>： 元素从文档流中消失，在文档布局中不再分配空间，且不可交互；再显示原来这里不存在的结构会引起重排，性能开销较大。
...
css:
    ...
    .four <span class="token punctuation">{</span>
        ...
        .six <span class="token punctuation">{</span>
            ...
            z-index: -1<span class="token punctuation">;</span>
        <span class="token punctuation">}</span>
    <span class="token punctuation">}</span>


解析：
  z-index 属性设置一个定位元素沿 z 轴的位置，z轴定义为垂直延申到显示区的轴。如果为正数，则离用户更近，为负数则离用户更远。
    - 没有定位的元素 z-index 不生效；
    - 定位元素拥有更高堆叠顺序的元素总是会处于堆叠顺序较低的定位元素前面；
    - 子元素必然在父元素前面，不管是否为定位元素；
    - 同级定位元素的 z-index 相同时遵循“后来居上”，后面的定位元素堆叠顺序更前；
    - z-index 小于0的定位元素处于所有元素后面，仅在层叠上下文的背景颜色和边框前面。
  <span class="token operator">=</span><span class="token operator">&gt;</span> .three .two .one .five .six .four
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="实现三列布局" tabindex="-1"><a class="header-anchor" href="#实现三列布局"><span>实现三列布局</span></a></h3><blockquote><p><strong>实现左右两侧宽度固定，中间自适应</strong>：BFC块级布局，flex布局，table布局,css计算宽度布局</p><ul><li>绝对定位+中间版块不给宽度</li><li>两侧浮动+中间自动撑开（使用calc动态计算宽度，设置对应宽度margin）</li><li>flex，左右设置flex-basis，中间设置flex-grow</li></ul><p><strong>calc计算</strong></p><div class="language-css line-numbers-mode" data-ext="css" data-title="css"><pre class="language-css"><code><span class="token selector">&lt;div class= &quot;main&quot;&gt;
    &lt;div class=&quot;left&quot;&gt;&lt;/div&gt;
    &lt;div class=&quot;right&quot;&gt;&lt;/div&gt;
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></blockquote><h2 id="css" tabindex="-1"><a class="header-anchor" href="#css"><span>CSS</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>定位有哪些，有什么区别
...
- 如何提高动画的渲染性能
		- 这样使用GPU动画
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="js-es6" tabindex="-1"><a class="header-anchor" href="#js-es6"><span>JS &amp; ES6+</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>- es6有哪些新特性
...
- new的实现原理
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">## 数据类型</span>
...
<span class="token function">define</span><span class="token punctuation">(</span><span class="token punctuation">[</span><span class="token string">&quot;./a&quot;</span><span class="token punctuation">,</span> <span class="token string">&quot;./b&quot;</span><span class="token punctuation">]</span><span class="token punctuation">.</span><span class="token function">function</span><span class="token punctuation">(</span><span class="token parameter">a<span class="token punctuation">,</span> b</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
	...
	b<span class="token punctuation">.</span><span class="token function">doSomething</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></blockquote></blockquote><h3 id="声明提升-var" tabindex="-1"><a class="header-anchor" href="#声明提升-var"><span>声明提升 var</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token keyword">function</span> <span class="token function-name function">outter</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token builtin class-name">return</span> inner<span class="token punctuation">;</span>
    <span class="token keyword">function</span> <span class="token function-name function">inner</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span><span class="token punctuation">}</span>
    var inner<span class="token punctuation">;</span>
    inner <span class="token operator">=</span> <span class="token number">9</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
//问题是下面代码执行输出值是什么：
typeof outter<span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span> // <span class="token string">&#39;function&#39;</span>


说明：
js 引擎在解释代码前会先进行编译，编译阶段会将所有的变量声明和函数声明相关作用域关联起来，并且将这些声明提升到作用域顶部，然后到代码执行阶段才会进行变量赋值。
虽然第一行代码是 <span class="token variable"><span class="token variable">\`</span><span class="token builtin class-name">return</span> inner<span class="token variable">\`</span></span>，但 <span class="token variable"><span class="token variable">\`</span>var inner<span class="token variable">\`</span></span> 的变量声明和 <span class="token variable"><span class="token variable">\`</span><span class="token keyword">function</span> <span class="token function-name function">inner</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span><span class="token punctuation">}</span><span class="token variable">\`</span></span> 的函数声明会第一时间被提升到顶部。
函数提升优先于变量提升，在函数优先提升后，由于 inner 已经被声明为函数变量，后面 <span class="token variable"><span class="token variable">\`</span>var inner<span class="token variable">\`</span></span> 时编译器进行左查询<span class="token punctuation">(</span>LHS<span class="token punctuation">)</span>，发现同一作用域已经有该值会忽略该变量声明。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></blockquote><h2 id="ts" tabindex="-1"><a class="header-anchor" href="#ts"><span>TS</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>- typescript相较于JavaScript有什么优势和劣势？
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="never、unknow、any的区别" tabindex="-1"><a class="header-anchor" href="#never、unknow、any的区别"><span>never、unknow、any的区别</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>- any：绕开所有类型检查。可赋值给任何类型，任何类型可赋值给它。
- unknow：表示未知类型。使用时必须进行类型判断。任何类型可赋值给它，它只能赋值给 any 或 unknown 自身。
- never：表示不应出现的状态。不可赋值给任何类型<span class="token punctuation">(</span>除never自身<span class="token punctuation">)</span>，是所有类型的子类型
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="abstract、implements、extends-的区别" tabindex="-1"><a class="header-anchor" href="#abstract、implements、extends-的区别"><span>abstract、implements、extends 的区别</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>- abstract：声明抽象类和抽象成员，只管声明但不能被实例化<span class="token punctuation">(</span>只是定义类有哪些变量和方法<span class="token punctuation">)</span>
- extends：继承与扩展，子类继承父类的方法，而且可覆盖重写方法
- implements：履行契约，契约可以是interface和abstract定义
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="http" tabindex="-1"><a class="header-anchor" href="#http"><span>http</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>- 介绍一下http缓存
...
- tcp三次握手和四次挥手的步骤
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">## . XML 与 html 的区别</span>
<span class="token number">1</span>. xml 是可扩展标记语言，类似 html，但与html不同的是，xml标签没有被预定义，需要自行定义标签。
<span class="token number">2</span>. xml 用来传输和存储数据，焦点是数据内容；html 被设计用来显示数据，焦点是数据外观；
...
- http 传输的数据都是明文<span class="token punctuation">(</span>未加密<span class="token punctuation">)</span>，https 协议是由 http 和 ssl 协议构建的可进行加密传输和身份认证的网络协议，对 http 协议传输的数据进行加密处理，比 http 协议的安全性更高。
...
<span class="token comment">## . http1.0、http1.1、http2.0、http3</span>
    ...
    <span class="token number">4</span>. http3.0
        ...
        - 自定义的拥塞控制
        - 前向安全和前向纠错
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="http-请求跨域问题" tabindex="-1"><a class="header-anchor" href="#http-请求跨域问题"><span>http 请求跨域问题</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>- 跨域：是指浏览器不能执行其他网站的脚本，它是由浏览器的同源策略造成的。
...
- 实现跨域的方法
    ...
    <span class="token number">9</span>. websocket协议跨域
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="cookie、sessionstorage、localstorage-的区别" tabindex="-1"><a class="header-anchor" href="#cookie、sessionstorage、localstorage-的区别"><span>cookie、sessionStorage、localStorage 的区别</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>相同点：都存储在客户端
不同点：
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="ajax、fetch-和-axios-的区别" tabindex="-1"><a class="header-anchor" href="#ajax、fetch-和-axios-的区别"><span>AJAX、Fetch 和 axios 的区别</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token number">1</span>. AJAX
...
- 负载均衡技术：让性能更差的服务器不会称为整体系统的瓶颈，同时也要让性能好的服务器的资源得到充分利用。
- 动态分发与复制技术：将大部分静态资源分发复制到各地的加速节点上，以便缩短客户端与目标资源的路径。
- 缓存技术
      对于公司内联网用户来说，这意味着将内容在本地缓存，而无须通过专用的广域网来检索网页。
      对于Internet用户来说，这意味着将内容存储在他们的ISP的缓存器中，而无须通过Internet来检索网页。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="怎么更新-cdn-缓存" tabindex="-1"><a class="header-anchor" href="#怎么更新-cdn-缓存"><span>怎么更新 CDN 缓存</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>当用户更新静态资源（如 JS、CSS、图片）时，由于 CDN 缓存，用户可能仍然访问到旧版本的资源。这会导致问题，尤其是当资源内容发生不兼容变更时。

<span class="token number">1</span>. 构建时调整资源的版本号/哈希值
...
<span class="token number">2</span>. CDN缓存手动刷新 / 自动化刷新CDN脚本
<span class="token number">3</span>. 利用 Service Worker 控制缓存
<span class="token number">4</span>. HTML文件设置 no-cache
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="性能优化" tabindex="-1"><a class="header-anchor" href="#性能优化"><span>性能优化</span></a></h2><h2 id="框架通识" tabindex="-1"><a class="header-anchor" href="#框架通识"><span>框架通识</span></a></h2><blockquote><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>- React-router、vue-router原理
...
- SPA单页面应用和多页面应用有什么区别
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></blockquote><h2 id="vue" tabindex="-1"><a class="header-anchor" href="#vue"><span>VUE</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>- data为什么是个函数，而不是对象
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">## vue2 数据双向绑定原理</span>
...
注意：既能用computed 实现又可以用watch 监听来实现的功能，推荐用computed， 重点在于computed 的缓存功能。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="vue2-跟-vue3-的区别" tabindex="-1"><a class="header-anchor" href="#vue2-跟-vue3-的区别"><span>vue2 跟 vue3 的区别</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token number">1</span>. 性能提升
	- 响应式系统底层实现优化：Vue3 使用 Proxy 替代 Object.defineProperty 实现响应式，并且使用了静态提升技术来提高渲染性能。
			- Vue2 使用 ES5 的 defineProperty 来进行数据的劫持。
					...
					- 还有很多情况下是监听不到的，因为 defineProperty 只能劫持已有的属性，对于新增属性和删除属性是拦截不到的，必须额外通过 <span class="token variable">$set</span>、 <span class="token variable">$delete</span> 这些 API 来手动触发页面的更新，无疑也是给开发者增加负担。
					- Vue2 中，数组不采用 defineProperty 来进行劫持 <span class="token punctuation">(</span>因为对所有索引进行劫持会造成性能浪费<span class="token punctuation">)</span>，需要对数组单独进行处理。同时无法监控到数组的长度的变化，同样也是需要使用 <span class="token variable">$set</span> 来处理。
	...
	- Diff 算法重写：新增了最长递归子序列的算法，来计算出最小的修改偏移量。还增加了静态标记。
			...
			- 希望将递归遍历树的方式，改成扁平化的方式，比如说只比较两棵树可能会发生变化的部分， 所以 Vue <span class="token number">3</span> 对模板编译进行优化。
			- 编译优化：重写了虚拟 DOM，提升了渲染速度。diff 时静态节点会被直接跳过
			- PatchFlags 记录静态节点，BlockTree 记录动态节点


<span class="token number">2</span>. 编码方式和设计理念改变
...
<span class="token number">3</span>. 对 TypeScript 的支持更加友好
	- 提供了完整的类型定义


<span class="token number">4</span>. 新增了更多特性
...
- 这两个方法应用于浏览器的历史记录站，在当前已有的 back、forward、go 的基础之上，它们提供了对历史记录进行修改的功能。这两个方法有个共同的特点：当调用他们修改浏览器历史记录栈后，虽然当前 URL改变了，但浏览器不会刷新页面，这就为单页应用前端路由“更新视图但不重新请求页面”提供了基础
     ...
     <span class="token string-property property">&quot;$route&quot;</span><span class="token operator">:</span> <span class="token punctuation">{</span>
       <span class="token function">handle</span><span class="token punctuation">(</span><span class="token parameter">n</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
- 类组件和纯函数组件的区别
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="对react的理解" tabindex="-1"><a class="header-anchor" href="#对react的理解"><span>对react的理解</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token number">1</span>. 单向数据流：数据通过props从父节点传递到子节点，如果父级的某个props改变，react会重新渲染所有的子节点
<span class="token number">2</span>. 高效：react通过虚拟DOM，最大限度减少与dom的交互
<span class="token number">3</span>. 组件化：通过react构建组件，把页面功能拆分，让代码更容易复用/维护
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="vue和react的区别" tabindex="-1"><a class="header-anchor" href="#vue和react的区别"><span>vue和react的区别</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>相同点：
    <span class="token number">1</span>. 都支持服务端渲染
    <span class="token number">2</span>. 都有虚拟dom、组件化开发、通过props参数进行父子组件数据传递
    <span class="token number">3</span>. 都实现webcomponent规范
    <span class="token number">4</span>. 都是数据驱动视图
    <span class="token number">5</span>. 都有状态管理，react有redux，vue有vuex
    <span class="token number">6</span>. 都支持native的方案，react有react native，vue有weex

不同点：
		<span class="token number">1</span>. react严格上只针对mvc的view层，vue是mvvm模式
		<span class="token number">2</span>. 虚拟dom不同。vue会跟踪每一个组件的依赖关系，不需要重新渲染整个dom组件树；react当应用的状态被改变时，全部组件都会重新渲染，所以react中用<span class="token variable"><span class="token variable">\`</span>shouldComponentUpdate<span class="token variable">\`</span></span>钩子函数来控制
		<span class="token number">3</span>. 组件写法不同，react是jsx+inline style，即把html和css都写进js；vue则是html、css、js在同一个文件
		<span class="token number">4</span>. 数据绑定不同，vue实现数据双向绑定，react数据流动是单向的
		<span class="token number">5</span>. 在react中state需要用setstate方法进行更新状态；在vue中state对象不是必须的，数据由data属性在vue对象中管理
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="虚拟dom与diff算法" tabindex="-1"><a class="header-anchor" href="#虚拟dom与diff算法"><span>虚拟dom与diff算法</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>- 虚拟DOM及虚拟节点，是通过js的object对象模拟DOM中的节点，然后通过特定的渲染方法将其渲染成真实的DOM节点。频繁的操作DOM，或大量造成页面的重绘和回流
- diff算法：把树形结构按照层级分解，只比较同级元素，给列表结构的每个单元添加唯一的key值，可以方便比较，防止不必要的重新赋值渲染


<span class="token comment">#### 为什么虚拟DOM会提高性能？</span>
- 因为虚拟DOM相当于在js和真实DOM中间加入一个缓存，利用DOM diff算法避免没必要的DOM操作，从而提高性能


<span class="token comment">#### 调用setState之后发生了什么？</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="react的生命周期函数" tabindex="-1"><a class="header-anchor" href="#react的生命周期函数"><span>react的生命周期函数</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>- componentWillMount：组件渲染前调用
...
<span class="token comment">#### shouldCoponentUpdate是做什么的？</span>
该钩子函数是为了解决：在更新数据时用setState修改整个数据，数据改变后，遍历时所有内容都要被重新渲染，若数据量庞大则会严重影响性能
  <span class="token number">1</span>. 使用<span class="token variable"><span class="token variable">\`</span>shouldComponentUpdate<span class="token variable">\`</span></span>在渲染前进行判断组件是否更新，更新了再渲染
  <span class="token number">2</span>. 使用<span class="token variable"><span class="token variable">\`</span>purecomponent<span class="token punctuation">(</span>纯组件<span class="token punctuation">)</span><span class="token variable">\`</span></span>省去虚拟DOM生成和对比的过程，在类组件中使用
  <span class="token number">3</span>. 使用<span class="token variable"><span class="token variable">\`</span>react.memo<span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token variable">\`</span></span>，类似于纯组件，在无状态组件中使用


<span class="token comment">#### 在react组件的何处发起ajax请求？</span>
在react组件中，应在componentDidMount钩子函数中发起网络请求。这个方法会在组件第一次挂载<span class="token punctuation">(</span>被添加到DOM<span class="token punctuation">)</span>时执行，在组件的生命周期中仅会执行一次。更重要的是，你不能保证在组件挂载之前ajax请求已经完成，如果是这样尝试在一个未挂载的组件上调用setState，这将不起作用。在componentDidMount中发起网络请求将保证这一个组件可以更新
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="合成事件-与-原生事件-的区别" tabindex="-1"><a class="header-anchor" href="#合成事件-与-原生事件-的区别"><span>合成事件 与 原生事件 的区别</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token number">1</span>. 抹平了浏览器之间的兼容问题
<span class="token number">2</span>. 对所有事件中心化管控，在组件挂载销毁时统一订阅和移除事件（事件委托）
		事件池、统一监听、数据变更时批量订阅和销毁
<span class="token number">3</span>. 减少内存：引入事件池避免垃圾回收，再事件池获取或释放事件对象，避免频繁的创建和销毁
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="组件的状态state和属性props的区别" tabindex="-1"><a class="header-anchor" href="#组件的状态state和属性props的区别"><span>组件的状态state和属性props的区别</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token number">1</span>. props 是父组件入的参数，只读不能修改
<span class="token number">2</span>. state 是组件自身设定的参数，可修改数据
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="react组件间的数据传递" tabindex="-1"><a class="header-anchor" href="#react组件间的数据传递"><span>react组件间的数据传递</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token number">1</span>. 正向传值用props
<span class="token number">2</span>. 逆向传值用函数传值，通过事件调用函数传递
<span class="token number">3</span>. 同级传值用pubsub-js
		- 用<span class="token variable"><span class="token variable">\`</span>pubsub.publish<span class="token punctuation">(</span>事件名, 数据<span class="token punctuation">)</span><span class="token variable">\`</span></span>来抛出数据
		- 用<span class="token variable"><span class="token variable">\`</span>pubsub.subscribe<span class="token punctuation">(</span>监听的事件, <span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token operator">=</span><span class="token operator">&gt;</span><span class="token punctuation">{</span><span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token variable">\`</span></span>接收数据
<span class="token number">4</span>. 跨组件传递数据使用context
		要用context进行跨组件传值用createContext<span class="token punctuation">(</span><span class="token punctuation">)</span>方法，此方法有两个对象，provider是生产者，Consumer是消费者
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="webpack" tabindex="-1"><a class="header-anchor" href="#webpack"><span>webpack</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>- 为什么webpack打包慢？为什么vite会比webpack快？如果想提高webpack速度，应该怎么做？
		Webpack优化
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="nodejs" tabindex="-1"><a class="header-anchor" href="#nodejs"><span>NodeJS</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>- 进程间通信方式有哪些？
- 浏览器的事件循环是怎样的？与Node的事件循环有哪些不同
- Node模块引入过程中，寻址过程是什么
- Node底层的事件循环机制是如何试下的？（libuv做了哪些事情？）
- 是否了解<span class="token variable"><span class="token variable">\`</span>rpc<span class="token variable">\`</span></span>和<span class="token variable"><span class="token variable">\`</span>grpc<span class="token variable">\`</span></span>？
- NodeJS中如何分析内存泄漏？
- 是否了解appKey和AppSecret这种加密机制？包括过程描述、解决的问题、底层加密原理是什么？
- Buffer的作用？
- NodeJS中的this指向问题
- NodeJS中的模块引入方式CommonJS与ES6的import/export的区别是什么？
- NodeJS中内存回收机制是怎样的？
...
* Node中的三种异步，网络IO、文件读写IO、代码自定义的IO如setTimeout<span class="token punctuation">(</span><span class="token punctuation">)</span>等，他们的底层分别是如何实现的？
...
* 说你对于V8引擎的理解？
- Chrome V8的运行机制是怎样的？
* V8中的垃圾回收机制是怎样的？垃圾回收机制中，如何识别哪些对象被使用，哪些已经被释放？
...
- Egg.js和Koa两个框架的区别是什么？
- Egg是如何获取各个Plugin的依赖关系的？
- Egg是如何做进程管理的？
- Egg的启动过程是怎样的？请详细描述整个过程都发生了什么

* express中app.use的原理是什么？
* express中的注册多个中间件后，各个中间件的执行顺序是什么？

* PM2的多进程管理与EggJS的多进程管理有什么区别？
* PM2中是否有Agent？如何实现类似Egg中Agent的工作，即如何避免多进程会实现的
* PM2的原理是什么？
* 跨进程通信方式有哪些？
- PM2如何实现应用内存超过限制后就会自动重启？
...
* 你在数据可视化分析平台担任了什么？
* 日增量一亿是如何处理及优化的？
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="移动端" tabindex="-1"><a class="header-anchor" href="#移动端"><span>移动端</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>* 介绍一下目前都有哪些Hybrid的方案？优点和缺点都有哪些？
* App如何应对DNS劫持？
* HybridApp上如何利用平台优势进行优化？

* 介绍一下你对<span class="token string">&quot;微前端&quot;</span>的了解？
...
* 自定义指令的底层原理
* JS中函数传参的原理
* 为什么与ES6模块支持<span class="token string">&quot;静态解析&quot;</span>？
* JS中支持异步的场景有哪些？
* 对象的构造函数是否可以使用剪头函数？为什么
* 实现一个LRU存储类
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="网络安全" tabindex="-1"><a class="header-anchor" href="#网络安全"><span>网络安全</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>* sso校验的整个过程是怎样的？
* sso校验过程中加密算法是怎样的？

* appKey+appSecret这种机制的作用是什么？
- 简述<span class="token variable"><span class="token variable">\`</span>OAuth <span class="token number">2.0</span><span class="token variable">\`</span></span>整个验证过程是怎样的？
* 介绍一下<span class="token variable"><span class="token variable">\`</span>OAuth2.0<span class="token variable">\`</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="小程序" tabindex="-1"><a class="header-anchor" href="#小程序"><span>小程序</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token number">1</span>. 小程序的运行环境是怎样的？
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="将来" tabindex="-1"><a class="header-anchor" href="#将来"><span>将来</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token number">1</span>. 你将来的人生规划是什么？是走技术路线？还是管理路线
...
第一家公司离职原因：
第一家公司没有成熟的体系架构，因为自己比较年轻，所以还是希望能来像你们这样人数规模比较庞大的公司发展。
想跟更多的前端大牛去学习，以提升自己和鞭笞自己。


发展规划
入职一家新公司后的话：
<span class="token number">1</span>. 短期目标<span class="token punctuation">(</span><span class="token number">1</span>-2年<span class="token punctuation">)</span>：深度融入团队与业务，掌握公司技术栈、开发流程与业务，成为项目中值得信赖的开发力量。
<span class="token number">2</span>. 中期目标<span class="token punctuation">(</span><span class="token number">3</span>-5年<span class="token punctuation">)</span>：希望能够参与甚至主导前端架构的设计和技术选型，比如在性能优化、工程化体系建设、微前端落地等方面进行深入探索和实践。
<span class="token number">3</span>. 长期目标<span class="token punctuation">(</span><span class="token number">5</span>年+<span class="token punctuation">)</span>：引领与创新，希望能成长为一名在某一领域有深厚积淀的技术专家（或架构师），能结合业务发展，在前端基础建设、用户体验优化、或者通过新技术（如AI+前端）驱动业务创新等方面，为团队和公司创造更大的价值。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="自我介绍" tabindex="-1"><a class="header-anchor" href="#自我介绍"><span>自我介绍</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">## 自我介绍</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="前端工程的价值体现在哪" tabindex="-1"><a class="header-anchor" href="#前端工程的价值体现在哪"><span>前端工程的价值体现在哪？</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token number">1</span>. 为简化用户使用提供技术支持（交互部分）
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="对前端架构师的理解" tabindex="-1"><a class="header-anchor" href="#对前端架构师的理解"><span>对前端架构师的理解</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>负责前端团队的管理及与其他团队的协调工作，提升团队成员能力和整体效率；
带领团队完成研发工具及平台前端部分的设计、研发和维护；
带领团队进行前端领域前沿技术研究及新技术调研，保证团队的技术领先
负责前端开发规范制定、功能模块化设计、公共组件搭建等工作，并组织培训。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="对前端界面工程师职位是怎么样理解的-它的前景会怎么样" tabindex="-1"><a class="header-anchor" href="#对前端界面工程师职位是怎么样理解的-它的前景会怎么样"><span>对前端界面工程师职位是怎么样理解的？它的前景会怎么样？</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>前端是最贴近用户的程序员，比后端、数据库、产品经理、运营、安全都近。（此回答可能会被问其他岗位的区别）
前端是最贴近用户的程序员，前端的能力就是能让产品从 <span class="token number">90</span>分进化到 <span class="token number">100</span> 分，甚至更好。
    <span class="token number">1</span>、实现界面交互
    <span class="token number">2</span>、提升用户体验
    <span class="token number">3</span>、有了Node.js，前端可以实现服务端的一些事情
...
前端的职责
	...
	- 处理hack，兼容、写出优美的代码格式；
	- 针对服务器的优化、拥抱最新前端技术。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="你是怎么学习新知识的" tabindex="-1"><a class="header-anchor" href="#你是怎么学习新知识的"><span>你是怎么学习新知识的？</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>如果有人已经在我们前面走过弯路摸索过，而我们就应该沿着他们摸索出来的道路上前行，而不是多花许多无谓的时间琢磨。
...
<span class="token number">1</span>. 未知领域：
	基础学习：先通过视频学习，获取别人的总结经验，这样可以更容易理解以及避免一些错误。
	进阶扎实基础：了解大概后，就自己去 github 上找参考代码去模仿学习。
	发现问题：主要是看源码和官网说明，还有看掘金之类的论坛去解决问题
<span class="token number">2</span>. 已知领域：
	看官网跟源码
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="学习新框架概要" tabindex="-1"><a class="header-anchor" href="#学习新框架概要"><span>学习新框架概要</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token number">1</span>. 这个框架是什么？即简介
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="平时如何管理你的项目" tabindex="-1"><a class="header-anchor" href="#平时如何管理你的项目"><span>平时如何管理你的项目？</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token number">1</span>. 前期团队必须确定好全局样式（globe.css），编码模式（utf-8）等；
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="如何保证code-review的质量" tabindex="-1"><a class="header-anchor" href="#如何保证code-review的质量"><span>如何保证code review的质量</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">## 如何保证code review的质量</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="网站重构的理解" tabindex="-1"><a class="header-anchor" href="#网站重构的理解"><span>网站重构的理解</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>网站重构：在不改变外部行为的前提下，简化结构、添加可读性，而在网站前端保持一致的行为。也就是说是在不改变UI的情况下，对网站进行优化，在扩展的同时保持一致的UI。


<span class="token comment">### 重构的方向</span>
- 对于传统的网站来说重构通常是：表格<span class="token punctuation">(</span>table<span class="token punctuation">)</span>布局改为DIV+CSS，使网站前端兼容于现代浏览器<span class="token punctuation">(</span>针对于不合规范的CSS、如对IE6有效的<span class="token punctuation">)</span>
- 对于移动平台的优化
- 针对于SEO进行优化
- 深层次的网站重构应该考虑的方面


<span class="token comment">### 重构的原则</span>
  - 减少代码间的耦合
  - 让代码保持弹性
  - 严格按规范编写代码
  - 设计可扩展的API
  - 代替旧有的框架、语言<span class="token punctuation">(</span>如VB<span class="token punctuation">)</span>
  - 增强用户体验
通常来说对于速度的优化也包含在重构中


<span class="token comment">### 重构带来的优化</span>
- 压缩JS、CSS、image等前端资源<span class="token punctuation">(</span>通常是由服务器来解决<span class="token punctuation">)</span>
- 程序的性能优化<span class="token punctuation">(</span>如数据读写<span class="token punctuation">)</span>
- 采用CDN来加速资源加载
- 对于JS DOM的优化
- HTTP服务器的文件缓存
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="过往工作中遇到的问题-解决方案" tabindex="-1"><a class="header-anchor" href="#过往工作中遇到的问题-解决方案"><span>过往工作中遇到的问题 &amp; 解决方案</span></a></h4><blockquote><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">## 2. 过往工作中遇到的问题 &amp; 解决方案</span>
