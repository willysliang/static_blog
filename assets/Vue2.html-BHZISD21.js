import{_ as n,o as s,c as a,d as t}from"./app-Bf_tkh-q.js";const e="/blog/assets/image-20201117235906290-8UsFVjuB.png",p="/blog/assets/vue_Architecture-HOmmmssL.png",l="/blog/assets/image-20230308184732048-gNZlKpzh.png",o="/blog/assets/image-20211102161402565-DuDY4z4d.png",c="/blog/assets/image-20210910105541211-BELJ1vFU.png",i="/blog/assets/998023-20180519213134497-676744027-DlD1Xxs8.png",u="/blog/assets/image-20201229000721595-DQJi5Pq1.png",r="/blog/assets/image-20210105104406137-OHB4HLZg.png",d="/blog/assets/image-20210105104341788-DjqHKmUa.png",k="/blog/assets/image-20210917102119532-FzJUQjeT.png",v="/blog/assets/image-20210719171619593-DIshIte2.png",m="/blog/assets/image-20220825194922734-D6HymVmk.png",b="/blog/assets/image-20210416003100883-iTKhYyz2.png",g="/blog/assets/image-20210731230204839-Ca6y_0aS.png",h="/blog/assets/image-20210505164210975-Cbm3-moQ.png",y="/blog/assets/image-20210923111020342-BUDWRlyp.png",q={},f=t(`<h2 id="vue2-0" tabindex="-1"><a class="header-anchor" href="#vue2-0"><span>Vue2.0</span></a></h2><h2 id="vue的认知" tabindex="-1"><a class="header-anchor" href="#vue的认知"><span>VUE的认知</span></a></h2><blockquote><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">## Vue 的认知</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="`+o+`" alt="image-20211102161402565"></p></blockquote><h3 id="vue2的生命周期" tabindex="-1"><a class="header-anchor" href="#vue2的生命周期"><span>Vue2的生命周期</span></a></h3><blockquote><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>- 生命周期：从 vue 实例创建、运行到销毁期间，总是伴随各种事件，这些事件统称为生命周期。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></blockquote><h3 id="虚拟dom" tabindex="-1"><a class="header-anchor" href="#虚拟dom"><span>虚拟DOM</span></a></h3><blockquote><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>DOM（Document Object Model）渲染是很慢的，其元素非常庞大，页面的性能问题鲜有由 JS 引起的，大部分都是由 DOM 操作引起的。如果对前端工作进行抽象的话，主要是维护状态和更新视图，而更新视图和维护状态都需要 DOM 操作。
...
Vue底层引入的 Virtual DOM<span class="token punctuation">(</span>虚拟DOM<span class="token punctuation">)</span> 在用 JS 对象表示 DOM 结构后，当页面状态发生变化而需要操作 DOM 时，可以先通过虚拟 DOM 计算出对真实 DOM 的最小修改量，然后再修改真实 DOM 结构<span class="token punctuation">(</span>因为真实DOM的操作代价太大<span class="token punctuation">)</span>。通过虚拟DOM计算出两颗真实DOM树之间的差异后，就可以修改真实的DOM结构。上文深度优先遍历过程产生了用于记录两棵树之间差异的数据结构patches, 通过使用patches可以方便对真实DOM做最小化的修改。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></blockquote><h3 id="diff算法" tabindex="-1"><a class="header-anchor" href="#diff算法"><span>Diff算法</span></a></h3><blockquote><ul><li><code>snabbdom</code> 是著名的<code>虚拟DOM</code>库，是 <code>diff</code> 算法的奠基者</li><li>虚拟DOM渲染：会比较跟之前元素是否有相同项，只重新渲染与之前元素的不同项</li></ul><p><img src="`+c+'" alt="image-20210910105541211"></p><ul><li><code>diff</code>算法是发生在 新旧<code>虚拟DOM</code>之上的，算出如何最小更新，最后反映到<code>真实DOM</code><ul><li>遍历旧虚拟DOM，遍历新虚拟DOM，比较不同，重新排序</li><li>只比较同一层级，不跨级比较虚拟DOM</li><li>先判断key值再判断标签名是否相同，都相同则认为是相同节点，不再继续深度比较</li></ul></li></ul><p><img src="'+i+'" alt="img"></p></blockquote><h3 id="runtime-compiler和runtime-only的区别" tabindex="-1"><a class="header-anchor" href="#runtime-compiler和runtime-only的区别"><span>runtime-compiler和runtime-only的区别</span></a></h3><p>vue程序运行过程：</p><p><img src="'+u+'" alt="image-20201229000721595"></p><ul><li><p>runtime-compiler运行过程：template--&gt;ast--&gt;render--&gt;virtual dom--&gt;UI</p></li><li><p>runtime-only运行过程：render--&gt;virtual dom--&gt;UI，所以性能相对更高，代码量更少</p><p>注意：runtime-only中不存在template</p></li></ul><h3 id="npm-run-build-dev运行过程" tabindex="-1"><a class="header-anchor" href="#npm-run-build-dev运行过程"><span>npm run build/dev运行过程</span></a></h3><p><img src="'+r+'" alt="image-20210105104406137"></p><p><img src="'+d+`" alt="image-20210105104341788"></p><h2 id="语法" tabindex="-1"><a class="header-anchor" href="#语法"><span>语法</span></a></h2><h3 id="插值" tabindex="-1"><a class="header-anchor" href="#插值"><span>插值</span></a></h3><blockquote><ul><li><p><strong>文本</strong></p><ul><li>数据绑定最常见的形式就是使用“Mustache”语法（双大括号）的文本插值</li><li>Mustache 标签将会被替代为对应数据对象上 <code>msg</code> property 的值。当绑定的数据对象上 <code>msg</code> property 发生改变，插值处的内容都会更新。</li><li>例：<code>&lt;span&gt;Message:{{ msg }}&lt;/span&gt;</code></li></ul></li><li><p><strong>v-once</strong></p><ul><li>通过使用<code>v-once</code>指令也能执行一次性地插值，当数据改变时，插值处的内容不会更新。但会影响到该节点上的其它数据绑定</li><li>例：<code>&lt;span v-once&gt;这个将不会改变: {{ msg }}&lt;/span&gt;</code></li></ul></li><li><p><strong>原始HTML <code>v-html</code></strong></p><ul><li>双大括号会将数据解释为普通文本，而非 HTML 代码。为了输出真正的 HTML，你需要使用 <code>v-html</code>指令</li><li><code>&lt;p&gt;{{ rawHtml }}&lt;/p&gt; &lt;span v-html=&quot;rawHtml&quot;&gt;&lt;/span&gt;</code></li></ul></li><li><p><strong>文本形式<code>v-text</code></strong></p><ul><li><code>&lt;p v-text=&quot;message&quot;&gt;v-text的内容，包括把标签一起输出来&lt;/p&gt;</code></li></ul></li><li><p>**不解析直接输出内容<code>v-pre</code> **</p><ul><li>（ pre 是 prevent的缩写，阻止解析）</li><li><code>&lt;p v-pre&gt;把{{ message }}直接输出&lt;/p&gt;</code></li></ul></li><li><p><strong>先解析再渲染<code>v-cloak</code></strong></p><ul><li><p>包含 v-cloak 属性的 html 标签在页面初始化时会被隐藏，</p></li><li><p>主要作用是防止当页面加载时，存在vue模板数据没加载到页面时触发(即防止页面中出现vue的变量名)，出现页面闪烁问题</p></li><li><p>注意：v-cloak要在样式中设置属性；若把<code>[v-cloak]</code>样式写在<code>@import style.css</code>的方式中，会出现页面闪烁问题，则我们可以改成link或内联样式的方式写入<code>[v-cloak]</code></p></li><li><div class="language-html line-numbers-mode" data-ext="html" data-title="html"><pre class="language-html"><code>// css
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></blockquote><h3 id="动画" tabindex="-1"><a class="header-anchor" href="#动画"><span>动画</span></a></h3><p>动画进入：</p><ul><li>v-enter：动画进入之前的<strong>初始</strong>状态，动画还没开始（是时间点）</li><li>v-enter-to：动画进入之后的<strong>结束</strong>状态，此时动画已经结束（时间点）</li><li>v-enter-active：动画进入的时间段</li></ul><p>动画离开：</p><ul><li>v-leave：动画离开之前的<strong>初始</strong>状态（时间点）</li><li>v-leave-to：动画离开之后的<strong>结束</strong>状态（时间点）</li><li>v-leave-active：动画离开的时间段</li></ul><p><img src="`+k+`" alt="image-20210917102119532"></p><div class="language-css line-numbers-mode" data-ext="css" data-title="css"><pre class="language-css"><code><span class="token selector">&lt;style&gt;
  .v-enter,
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="createelement" tabindex="-1"><a class="header-anchor" href="#createelement"><span>createElement</span></a></h3><div class="language-vue line-numbers-mode" data-ext="vue" data-title="vue"><pre class="language-vue"><code>const cpn = {
...
<span class="token keyword">const</span> <span class="token constant">VM</span> <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Vue</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
 ...
 <span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>组件优化</strong></p><div class="language-vue line-numbers-mode" data-ext="vue" data-title="vue"><pre class="language-vue"><code>//HTML
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>app<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span>
<span class="token comment">&lt;!-- 1.通过template标签 --&gt;</span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>cpnC1<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span>
 <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span><span class="token punctuation">&gt;</span></span>
     <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>h2</span><span class="token punctuation">&gt;</span></span>标题1<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>h2</span><span class="token punctuation">&gt;</span></span>
     <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>p</span><span class="token punctuation">&gt;</span></span>内容1<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>p</span><span class="token punctuation">&gt;</span></span>
 <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span><span class="token punctuation">&gt;</span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>template</span><span class="token punctuation">&gt;</span></span>

<span class="token comment">&lt;!-- 2.通过script标签，但是类型必须为text/x-template --&gt;</span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span> <span class="token attr-name">type</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>text/x-template<span class="token punctuation">&quot;</span></span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>myCpn<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span><span class="token script"><span class="token language-javascript">
 <span class="token operator">&lt;</span>div<span class="token operator">&gt;</span>
     <span class="token operator">&lt;</span>h2<span class="token operator">&gt;</span>标题<span class="token number">1</span><span class="token operator">&lt;</span><span class="token operator">/</span>h2<span class="token operator">&gt;</span>
     <span class="token operator">&lt;</span>p<span class="token operator">&gt;</span>内容<span class="token number">1</span><span class="token operator">&lt;</span><span class="token operator">/</span>p<span class="token operator">&gt;</span>
 <span class="token operator">&lt;</span>div<span class="token operator">&gt;</span>
</span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>script</span><span class="token punctuation">&gt;</span></span>
...
<span class="token literal-property property">props</span><span class="token operator">:</span> <span class="token punctuation">{</span>
  ...
  <span class="token comment">// 3、多类型定义</span>
  <span class="token literal-property property">flexibleProp</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token literal-property property">type</span><span class="token operator">:</span> <span class="token punctuation">[</span>String<span class="token punctuation">,</span> Number<span class="token punctuation">,</span> Boolean<span class="token punctuation">]</span><span class="token punctuation">,</span> <span class="token comment">// 允许 string/number/boolean</span>
    <span class="token keyword">default</span><span class="token operator">:</span> <span class="token string">&#39;&#39;</span> <span class="token comment">// 默认值（需考虑多类型兼容）</span>
  <span class="token punctuation">}</span><span class="token punctuation">,</span>

  <span class="token comment">// 复杂多类型（数组或对象）</span>
  <span class="token literal-property property">dataSource</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    ...
    <span class="token function-variable function">default</span><span class="token operator">:</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">(</span><span class="token punctuation">{</span><span class="token punctuation">}</span><span class="token punctuation">)</span> <span class="token comment">// 工厂函数返回新对象</span>
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="依赖注入-provider-inject" tabindex="-1"><a class="header-anchor" href="#依赖注入-provider-inject"><span>依赖注入 provider/inject</span></a></h4><blockquote><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>- 在父组件中通过 provider 来提供变量，然后再子组件中通过 inject 来注入变量。
...
<span class="token literal-property property">inject</span><span class="token operator">:</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">,</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></blockquote><h2 id="响应式原理" tabindex="-1"><a class="header-anchor" href="#响应式原理"><span>响应式原理</span></a></h2><h3 id="vue2响应式的缺陷" tabindex="-1"><a class="header-anchor" href="#vue2响应式的缺陷"><span>vue2响应式的缺陷</span></a></h3><blockquote><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>对象新增、删除属性没有响应式，数组新增、删除元素没有响应式，通过下标修改某个元素没有响应式，通过 <span class="token variable"><span class="token variable">\`</span>.length<span class="token variable">\`</span></span> 改变数组长度没有响应式。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ul><h3 id="this-nexttick-异步更新队列" tabindex="-1"><a class="header-anchor" href="#this-nexttick-异步更新队列"><span><code>this.$nextTick()</code>异步更新队列</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>vue 在更新 DOM 时是<span class="token string">&#39;异步&#39;</span>执行：
	只要侦听到数据变化，vue 会开启一个队列，并缓冲在同一事件循环<span class="token punctuation">(</span>EventLoop<span class="token punctuation">)</span>中进行所有数据变更。
	如果同一个数据触发多次 watcher，也只会把最后一次触发推入到队列中。
	这种在缓冲时去除同一个数据触发的多次数据变更对于避免不必要的计算和减少 DOM 操作的优化很重要。
在下一个事件循环 <span class="token string">&#39;tick&#39;</span> 中，vue 刷新队列并执行实际<span class="token punctuation">(</span>已去重<span class="token punctuation">)</span>工作。

this.<span class="token variable">$nextTick</span> 将回调延迟到下次DOM更新循环之后执行。在修改数据之后立即使用它，然后等待DOM更新。
<span class="token variable"><span class="token variable">\`</span>$nextTick<span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token variable">\`</span></span> 返回一个 <span class="token variable"><span class="token variable">\`</span>Promise<span class="token variable">\`</span></span> 对象


<span class="token comment">### 多级降级策略</span>
vue2 在内部对异步队列使用了多级降级策略（Promise <span class="token operator">&gt;</span> MutationObserver <span class="token operator">&gt;</span> setImmediate <span class="token operator">&gt;</span> setTimeout）
	先使用原生的 <span class="token variable"><span class="token variable">\`</span>Promise.then<span class="token variable">\`</span></span>、<span class="token variable"><span class="token variable">\`</span>MutationObserver<span class="token variable">\`</span></span> 和 <span class="token variable"><span class="token variable">\`</span>setImmediate<span class="token variable">\`</span></span>
	如果执行环境不支持，则会采用 <span class="token variable"><span class="token variable">\`</span>setTimeout<span class="token punctuation">(</span>fn, <span class="token number">0</span><span class="token punctuation">)</span><span class="token variable">\`</span></span> 代替


<span class="token comment">### vue2的 this.$nextTick 跟 vue3的 $nextTick 的区别</span>
内部实现策略不同：
	- vue2 使用多级降级策略（Promise <span class="token operator">&gt;</span> MutationObserver <span class="token operator">&gt;</span> setImmediate <span class="token operator">&gt;</span> setTimeout）
	- vue3 统一使用 Promise.resolve<span class="token punctuation">(</span><span class="token punctuation">)</span>.then<span class="token punctuation">(</span><span class="token punctuation">)</span> （因为vue3基于esmodule，不再做向下兼容）
性能优化
	- vue2 高频调用可能导致“微任务爆炸”
	- 任务合并机制，同一时间循环的多次调用共享一个微任务
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-vue line-numbers-mode" data-ext="vue" data-title="vue"><pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>example<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span>{{message}}<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="路由" tabindex="-1"><a class="header-anchor" href="#路由"><span>路由</span></a></h2><ul><li><p>路由是通过互联的网络把信息从源地址传输到目的地址的活动。</p></li><li><p>路由器提供了两种机制：路由和转送</p><ul><li>路由是决定数据数据包从来源到目的地的路径。</li><li>转送是输入端的数据转移到合适的输出端。</li></ul></li><li><p>路由表本质上时一个映射表，决定了数据包的指向。</p></li><li><p>后端渲染：</p><ul><li>通过转发和重定向发送数据给服务器来渲染好对应的HTML页面，返回给客户端进行展示。</li><li>每个页面由对应的URL，url会发送到服务器，服务器通过正则对该URL进行匹配，然后交给Controller进行处理，最终生成HTML或数据，返回给前端，此为I/O操作。——后端路由</li></ul></li><li><p>前端渲染：</p><ul><li>前后端分离阶段(ajax)：后端只负责提供数据，不负责任何阶段的内容。浏览器中显示的页面的大部分内容都是前端写的JS代码在浏览器中执行，最终渲染出来的页面。</li><li>单页面富应用SPA阶段(vue)：在前后端分离基础上加一层前端路由，即由前端来维护一套路由规则(一个URL对应一个页面)</li><li>前端路由整体核心：改变URL，但是页面不进行整体的刷新。</li><li>改变页面的url但页面并不刷新的方案：url的hash和HTML5的history</li></ul></li></ul><h3 id="路由的使用" tabindex="-1"><a class="header-anchor" href="#路由的使用"><span>路由的使用</span></a></h3><blockquote><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 安装vue-router：</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></blockquote><p><img src="`+m+`" alt="image-20220825194922734"></p><h3 id="hash模式与history模式" tabindex="-1"><a class="header-anchor" href="#hash模式与history模式"><span>hash模式与history模式</span></a></h3><blockquote><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">## 路由的模式</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></blockquote><h4 id="history模式刷新404问题的nginx配置" tabindex="-1"><a class="header-anchor" href="#history模式刷新404问题的nginx配置"><span>History模式刷新404问题的Nginx配置</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>如果 vue-router 采用 <span class="token function">history</span> 模式，当用户在浏览器中直接访问或刷新非首页路由时，会出现 <span class="token number">404</span> 错误。
这是因为 vue-router 的 <span class="token function">history</span> 模式会产生类似 /about、/user/123 这样的 URL，当用户刷新页面时，浏览器会向服务器请求这些路径对应的文件，但服务器上实际并不存在这些文件，因此返回 <span class="token number">404</span> 错误。
...
<span class="token punctuation">}</span>
这行配置的工作原理：
	<span class="token number">1</span>. 首先尝试访问请求的文件 <span class="token variable">$uri</span>
	<span class="token number">2</span>. 如果文件不存在，尝试访问对应目录 <span class="token variable">$url</span>/
	<span class="token number">3</span>. 如果目录也不存在，最后返回 index.html

注意事项：
  <span class="token number">1</span>. 注释掉原有的404配置
      error_page <span class="token number">404</span> /404.html<span class="token punctuation">;</span> <span class="token comment"># 注释掉这行，避免与Vue路由冲突</span>
  <span class="token number">2</span>. 静态资源处理：对于 CSS、JS、图片等静态资源，应该直接返回404而不是index.html，避免资源加载错误。
  <span class="token number">3</span>. API路由分离：如果项目有后端API，需要单独配置API路由，确保API请求不会被重定向到index.html
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-yaml line-numbers-mode" data-ext="yml" data-title="yml"><pre class="language-yaml"><code>server <span class="token punctuation">{</span>
    listen 80;
    server_name your<span class="token punctuation">-</span>domain.com;
    root /path/to/your/vue/dist;
    index index.html;

    <span class="token comment"># Vue Router支持</span>
    location / <span class="token punctuation">{</span>
        try_files $uri $uri/ /index.html;
    <span class="token punctuation">}</span>

    <span class="token comment"># 静态资源优化</span>
    location ~* \\.(js<span class="token punctuation">|</span>css<span class="token punctuation">|</span>png<span class="token punctuation">|</span>jpg<span class="token punctuation">|</span>jpeg<span class="token punctuation">|</span>gif<span class="token punctuation">|</span>ico<span class="token punctuation">|</span>svg<span class="token punctuation">|</span>woff<span class="token punctuation">|</span>woff2<span class="token punctuation">|</span>ttf<span class="token punctuation">|</span>eot)$ <span class="token punctuation">{</span>
        expires 1y;
        add_header Cache<span class="token punctuation">-</span>Control &quot;public<span class="token punctuation">,</span> immutable&quot;;
        try_files $uri =404;
    <span class="token punctuation">}</span>

    <span class="token comment"># API接口路由(如果有后端API)</span>
    location /api <span class="token punctuation">{</span>
        try_files $uri $uri/ @fallback;
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="通过代码修改路由" tabindex="-1"><a class="header-anchor" href="#通过代码修改路由"><span>通过代码修改路由</span></a></h3><div class="language-vue line-numbers-mode" data-ext="vue" data-title="vue"><pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>app<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>重要提示：如果使用SSR模式，请确保在 mounted 钩子中注册模块。否则可能导致内存泄漏，因为beforeDestroy钩子在服务器端不能执行。</p></blockquote><p><img src="`+y+`" alt="image-20210923111020342"></p><h3 id="项目结构" tabindex="-1"><a class="header-anchor" href="#项目结构"><span>项目结构</span></a></h3><p>Vuex 并不限制你的代码结构。但是，它规定了一些需要遵守的规则：</p><ol><li>应用层级的状态应该集中到单个 store 对象中。</li><li>提交 <strong>mutation</strong> 是更改状态的唯一方法，并且这个过程是同步的。</li><li>异步逻辑都应该封装到 <strong>action</strong> 里面。</li></ol><p>如果 store 文件太大，只需将 action、mutation 和 getter 分割到单独的文件。</p><p>对于大型应用，一般会把 Vuex 相关代码分割到模块中。</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>├── index.html
├── main.js
├── api
